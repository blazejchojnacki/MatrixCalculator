...
def inverse(matrix):
    ...
    if determinant != 0:
        ...
        inverse_matrix = transpose(Matrix(inverted))
...
def row_permute(matrix, permuted_row_1, permuted_row_2):
    ...
    permuted_matrix = Matrix(permuted)
